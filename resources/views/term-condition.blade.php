...
<body class="{{ $themeMode == 'dark' ? 'dark_theme' : 'light_theme' }}">
    ...
    These terms and conditions outline the rules and regulations for the use of Unistore's Website, located at
    www.unistore.uz.

    By accessing this website we assume you accept these terms and conditions. Do not continue to use Unistore if you do
    ...
    accordance with and subject to, prevailing law of uz. Any use of the above terminology or other words in the
    singular, plural, capitalization and/or he/she or they, are taken as interchangeable and therefore as referring to
    same.

    Cookies
    We employ the use of cookies. By accessing Unistore, you agreed to use cookies in agreement with the Unistore's
    Privacy Policy.
    ...
    License
    Unless otherwise stated, Unistore and/or its licensors own the intellectual property rights for all material on
    Unistore. All intellectual property rights are reserved. You may access this from Unistore for your own personal use
    subjected to restrictions set in these terms and conditions.

    You must not:

    Republish material from Unistore
    Sell, rent or sub-license material from Unistore
    Reproduce, duplicate or copy material from Unistore
    Redistribute content from Unistore
    ...
    of the website. Unistore does not filter, edit, publish or review Comments prior to their presence on the website.
    Comments do not reflect the views and opinions of Unistore,its agents and/or affiliates. Comments reflect the views
    and opinions of the person who post their views and opinions. To the extent permitted by applicable laws, Unistore
    ...
    Unistore reserves the right to monitor all Comments and to remove any Comments which can be considered
    ...
    activity.
    You hereby grant Unistore a non-exclusive license to use, reproduce, edit and authorize others to use, reproduce and
    ...
    with us; (c) the benefit to us from the visibility of the hyperlink compensates the absence of Unistore; and (d) the
    ...
    must inform us by sending an e-mail to Unistore. Please include your name, your organization name, contact
    ...
    No use of Unistore's logo or other artwork will be allowed for linking absent a trademark license agreement.
