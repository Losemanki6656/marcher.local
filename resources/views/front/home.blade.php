    ...
    @foreach ($allHomePageFeatures as $allHomePageFeature)
        <section class="relative py-20 overflow-hidden">
            <div class="container mx-auto px-8">
                <div
                    class="flex @if ($loop->even) flex-wrap md:flex-row-reverse @else flex-wrap @endif -m-6">
                    ...
                    <div class="w-full lg:w-1/2 p-6">
                        <div
                            class="@if ($loop->odd) mx-auto @else text-left @endif max-w-lg h-96 rounded-3xl">
                        ...
                        <div
                            ...
                            <div class="h-full px-7 py-8 bg-white rounded-lg">
                                ...
                                <h3 class="mb-1.5 font-heading font-bold text-lg text-gray-900">
                                    {{ $frontTestimonial->name }}</h3>
                                <div class="flex mb-3">
                                    @include('front.includes.rating', [
                                        'rating' => $frontTestimonial->rating,
                                    ])
                                </div>
                            </div>
                        </div>
