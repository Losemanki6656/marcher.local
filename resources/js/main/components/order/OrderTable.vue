<template>
    <a-row>
                ...
                <a-table :columns="columns" :row-key="(record) => record.xid" :data-source="table.data"
                    ...
                    <template #bodyCell="{ column, record }">
                        ...
                        <template v-if="column.dataIndex === 'action'">
                            <a-space v-if="record.order_type == 'online-orders' &&
                                record.order_status != 'delivered' &&
                                !record.cancelled
                                ">
                                <a-tooltip placement="topLeft" :title="$t('stock.view_order')">
                                ...
                                <a-tooltip v-if="record.order_status == 'ordered' &&
                                    !record.cancelled
                                    " placement="topLeft" :title="$t('common.confirm')">
                                    <a-button type="primary" @click="confirmOrder(record)">
                                        <template #icon>
                                            <CheckOutlined />
                                        </template>
                                    </a-button>
                                </a-tooltip>
                                <a-tooltip v-if="!record.cancelled &&
                                    record.order_status != 'ordered' &&
                                    record.order_status != 'delivered'
                                    " placement="topLeft" :title="$t('online_orders.confirm_delivery')">
                                    <a-button type="primary" @click="confirmDelivery(record)">
                                        <template #icon>
                                            <SendOutlined />
                                        </template>
                                    </a-button>
                                ...
                                <a-tooltip v-if="!record.cancelled &&
                                    record.order_status != 'delivered'
                                    " placement="topLeft" :title="$t('common.cancel')">
                                    <a-button type="primary" @click="cancelOrder(record)" danger>
                                        <template #icon>
                                            <StopOutlined />
                                        </template>
                                    </a-button>
                            ...
                            <a-dropdown v-else-if="record.order_type == 'stock-transfers'" placement="bottomRight">
                                <MoreOutlined />
                                <template #overlay>
                                    <a-menu>
                                        <a-menu-item key="view" v-if="permsArray.includes(
                                        ...
                                        <a-menu-item key="edit" v-if="filters.transfer_type == 'transfered' &&
                                            (permsArray.includes(
        ...
        ">
                                        ...
                                        <a-menu-item key="delete" v-if="filters.transfer_type == 'transfered' &&
                                            (permsArray.includes(
                            ...
                            <a-dropdown v-else placement="bottomRight">
                                ...
                                <template #overlay>
                                    <a-menu>
                                        ...
                                        <a-menu-item key="edit" v-if="record.order_type != 'online-orders' &&
                                            (permsArray.includes(
                                                `${pageObject.permission}_edit`
                                            ) ||
                                                permsArray.includes('admin'))
        ...
        ">
                                        ...
                                        <a-menu-item key="delete" v-if="record.order_type != 'online-orders' &&
                                            (permsArray.includes(
                                                `${pageObject.permission}_delete`
                                            ) ||
                                                permsArray.includes('admin')) &&
