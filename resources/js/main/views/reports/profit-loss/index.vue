    ...
    <a-card class="page-content-container">
        <!-- <a-row :gutter="[15, 15]" class="mb-20">
            <a-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
                <a-tabs v-model:activeKey="filters.active_report_type">
                    <a-tab-pane key="daily_income">
                        <template #tab>
                            <span>
                                <UnorderedListOutlined />
                                {{ $t("common.daily_income") }}
                            </span>
                        </template>
                    </a-tab-pane>
                    <a-tab-pane key="average_price">
                        <template #tab>
                            <span>
                                <BarChartOutlined />
                                {{ $t("common.average_price") }}
                            </span>
                        </template>
                    </a-tab-pane>
                </a-tabs>
            ...
            <a-col :span="24" class="mt-10">
                ...
                >
                    ...
                    <a-descriptions-item>
                        ...
                        {{ formatAmountCurrency(reportData.stock_transfer_transfered) }}
                    </a-descriptions-item>
                    <a-descriptions-item>
                        <template #label>
                            {{ $t("stock_transfer.stock_transfer_received") }} (-)
                        </template>
                        {{ formatAmountCurrency(reportData.stock_transfer_received) }}
                    </a-descriptions-item>
                    <a-descriptions-item>
