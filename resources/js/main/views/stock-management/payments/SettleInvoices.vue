    ...
    <a-row>
        <a-col :span="24">
            <div class="table-responsive">
                <a-table :columns="settleInvoiceColumns" :row-key="(record) => record.xid" :data-source="invoices"
                    :pagination="false">
                    <template #bodyCell="{ column, record }">
                        ...
                        <template v-if="column.dataIndex === 'action'">
                            <a-input-number :addonBefore="appSetting.currency.symbol" v-model:value="record.paying_amount"
                                placeholder="0" :min="0" @blur="inputValueChanged(record)" />
                        </template>
                    </template>
